...
\usepackage[spanish]{babel} % Cambiar el idioma a español
\usepackage[utf8]{inputenc} % Permitir el uso de caracteres especiales como tildes y ñ
\usepackage[T1]{fontenc} % Permitir el uso de caracteres especiales como tildes y ñ
\usepackage{array}
...
% se intento pero no me deja overleaf papu
